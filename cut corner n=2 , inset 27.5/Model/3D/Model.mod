...
With Brick
     ...
     .Component "component1" 
     .Material "Nickel" 
     .Xrange "-133.7/2", "-93.125/2" 
     .Yrange "(-104.8+l1)/2", "(-94.15+l1)/2" 
     .Zrange "ht+hs", "ht+hs+ht" 
     .Create
End With
...
With Brick
     ...
     .Component "component1" 
     .Material "Nickel" 
     .Xrange "-133.7/2", "-106.65/2" 
     .Yrange "(-104.8+l2)/2", "(-94.15+l2)/2" 
     .Zrange "ht+hs", "ht+hs+ht" 
     .Create
End With
...
With Brick
     ...
     .Component "component1" 
     .Material "Nickel" 
     .Xrange "-133.7/2", "-120.175/2" 
     .Yrange "(-104.8+l3)/2", "(-94.15+l3)/2" 
     .Zrange "ht+hs", "ht+hs+ht" 
     .Create
End With
...
'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Solid.Subtract "component1:feedline", "component1:n=4 top right" 
