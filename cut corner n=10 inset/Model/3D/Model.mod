...
'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Pick.PickEndpointFromId "component1:solid1", "337"
...
'@ delete shape: component1:empty space

'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Solid.Delete "component1:empty space"
...
'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Pick.ForceNextPick 
Pick.PickFaceFromId "component1:solid1", "328" 
...
With WCS
     .SetNormal "0", "0", "1"
     .SetOrigin "-4.0130133402511e-016", "-3.6481939456828e-017", "1.67"
     .SetUVector "1", "0", "0"
End With
...
'@ boolean subtract shapes: component1:solid1, component1:empty space

'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Solid.Subtract "component1:solid1", "component1:empty space"
...
'@ boolean add shapes: component1:solid1, component1:feedline

'[VERSION]2015.0|24.0.2|20150116[/VERSION]
Solid.Add "component1:solid1", "component1:feedline" 
